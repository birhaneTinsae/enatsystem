                ...
                <div class="panel-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>{{$branch->code}}</td>
                            <td>{{$branch->name}}</td>
                            <td><a href="" class="btn btn-success btn-sm" data-toggle="modal" data-target="#branchDetailModal"
                                    data-id="{{$branch->id}}"><i class="fa fa-info-circle"></i></a></td>
                            <td><a href="" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#branchUpdateModal"
                                    data-id="{{$branch->id}}"><i class="fa fa-edit"></i></a></td>
