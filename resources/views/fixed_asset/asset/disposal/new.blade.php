                    ...
                    {{csrf_field()}}
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="current_value">Current Status</label>
                                        @if ($asset->disposed==="0")
		                            <span class="label label-success">Active</span>
		                             <input type="checkbox" name="disposed" checked disabled>
		                            
                                 @else
                                     <label class='label label-danger'>Disposed</label>
                                  @endif
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                   ...
                                   <span class="label label-danger">Disposed</span> 
                                   <input type="checkbox" name="disposed"  required>
                                </div>
                                </div> 
                                <div class="form-group">
                                    <label for=""></label>
                                    <input type="submit" value="Dispose" class="btn btn-success btn-block">
                                </div>
                            </div>
                        </div>
                    </form>
