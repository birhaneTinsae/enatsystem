        ...
        <form action="searchtransferpromotionrequest" method="get">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">Employees Transfer/ Request Records
                    ...
                    @can('create', App\Transferpromotionrequest::class)
                        ...
                        <tbody>
                         ...
                         @endphp  
                            ...
                            <tr>                                
                                ...
                                <td>
                                 <a href="{{ route('transferpromotionrequest.show', $employee->id) }}" class="btn-success btn-sm">
                                 <i class="fa fa-info-circle"></i> </a>
                                 </td>
                                @can('update',App\Transferpromotionrequest::class)
                                <td>                                
                                <a href="{{ route('transferpromotionrequest.edit', $employee->id) }}" class="btn-warning btn-sm" >
                                <i class="fa fa-edit"></i></a></td>
                                @endcan  
                                 @can('delete',App\Transferpromotionrequest::class)
                                  <td>
                                  	<form action="/transferpromotionrequest/{{ $employee->id}}" method="POST">
                    {{ method_field ('DELETE')}}
                        {{ csrf_field() }}		
...
<div class="modal modal-danger fade" id="closeModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="{{route('transferpromotionrequest.destroy','test')}}" method="post">
      		{{method_field('delete')}}
      		{{csrf_field()}}
