    ...
    <div class="row">
        ...
        <div class="col-md-10 ">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">New Job Position {{-- <a href="" class="text-right pull-right panel-menu-item"><i class="fa fa-times" aria-hidden="true"></i>
                        Close</a>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" name="name" id="job_position_name" value="{{ old('name') }}" placeholder="eg. Senior System Admin">                                    @if ($errors->has('name'))
                            ...
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->has('operation_class') ? ' has-error' : '' }}">
                                    ...
                                    </select> @if ($errors->has('operation_class'))
                                    <span class="help-block">
