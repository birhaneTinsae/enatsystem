                 ...
                 <div class="row">
                    <div class="col-md-6">
                       ...
                       {{-- <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control" name="registered_at" value="{{$tt->registered_at}}">
                        </div> --}}
                        {{--<div class="form-group">
                            <label for="disconnected_at">Disconnected At</label>
                            <input type="datetime-local" class="form-control" name="disconnected_at" value="{{$tt->disconnected_at}}">
                        </div>
                       <div class="form-group">
                            <label for="reconnected_at">Reconnected At</label>
                            <input type="datetime-local" class="form-control" name="reconnected_at" value="{{$tt->reconnected_at}}">
                        </div> --}}
                        <div class="form-group">
                            <label for="follow_up_no">Follow Up No</label>
                            <input type="text" class="form-control" name="follow_up_no" value="{{$tt->follow_up_no}}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <option value="{{$tt->status}}">{{$tt->status}}</option>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="remark" id="remark" cols="30" rows="10" class="form-control" >{{$tt->remarks}}</textarea>
                        </div>
