    ...
    <div class="row">
        ...
        {{--<ol class="breadcrumb">
            ...
            <div class="panel panel-default">
                ...
                <form action="/domain-name" method="post">
                @csrf
                 <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="bios_name" id="bios_name">
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="network_address" id="network_address" pattern="((25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)(\.|$)){4}">
                        </div>
                        <div class="form-group">
                            <label for="access_switch_address">Access Switch Address</label>
                            <input type="text" class="form-control" name="access_switch_address" id="access_switch_address" pattern="((25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)(\.|$)){4}">
                        </div>
                        <div class="form-group">
