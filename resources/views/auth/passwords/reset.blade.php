                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="/password-reset/{{Auth::id()}}">
                        ...
                        <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="username" type="username" class="form-control" name="username" value="{{ Auth::user()->username or old('username') }}"
                                    required readonly autofocus> @if ($errors->has('username'))
