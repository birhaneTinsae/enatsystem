                        ...
                        <tbody>
                         ...
                         ?>  
                            ...
                            <tr>                                
                                ...
                                <td>
                                 <a href="<?php echo e(route('actingemployee.show', $employee->id)); ?>" class="btn-success btn-sm">
                                 <i class="fa fa-info-circle"></i> </a>
                                 </td>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update',App\ActingEmployee::class)): ?>
                                <td>                                
                                <a href="<?php echo e(route('actingemployee.edit', $employee->id)); ?>" class="btn-warning btn-sm" >
                                <i class="fa fa-edit"></i></a></td>
                                <?php endif; ?>  
                                 <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete',App\ActingEmployee::class)): ?>
                                  <td>
...
<div class="modal modal-danger fade" id="closeModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="<?php echo e(route('actingemployee.destroy','test')); ?>" method="post">
      		<?php echo e(method_field('delete')); ?>
