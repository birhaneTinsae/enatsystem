                ...
                <div class="panel-body">
                    ...
                    <form method="POST" action="/hr">
                                ...
                                <div class="col-md-6">
                                   <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" required id="new-employee"
                                         name="full_name" placeholder="Employee" value="<?php echo e(old('full_name')); ?>">   
                            ...
                            <div class="form-group">
                                    ...
                                    <option value="M" <?php if(old('gender') == "M"): ?> <?php echo e('selected'); ?> <?php endif; ?>>Male</option>
                                    <option value="F" <?php if(old('gender') == "F"): ?> <?php echo e('selected'); ?> <?php endif; ?>>Female</option>
                         ...
                         <div class="form-group">
                            ...
                            id="employement_date" name="employement_date" value="<?php echo e(old('employement_date')); ?>" > 
                         ...
                         <div class="form-group">
                            ...
                            pattern="\d*" id="Phone_no" name="Phone_no" required value="<?php echo e(old('Phone_no')); ?>"  >  
                        ...
                        <div class="form-group">
                            ...
                            pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" value="<?php echo e(old('email')); ?>">    
                         ...
                         <div class="form-group">
                                            ...
                                            name="city" id="city" value="<?php echo e(old('city')); ?>">
                           ...
                           <div class="form-group">
                                            ...
                                            <input type="text"  class="form-control" name="woreda/kebele" value="<?php echo e(old('woreda/kebele')); ?>">

                                            <?php if($errors->has('woreda')): ?>
                                    <span class="help-block">
                                        <strong  class="text-danger"><?php echo e($errors->first('woreda')); ?></strong>
                                    </span>
                                    <?php endif; ?> 
                         </div>
                            ...
                            pattern="\d*" id="private_pension_no" name="private_pension_no" value="<?php echo e(old('private_pension_no')); ?>"  >                                
                        <?php if($errors->has('id')): ?>
                            ...
                            <input type="text" class="form-control"  maxlength="10" 
                            pattern="\d*" id="govt_pension_no" name="govt_pension_no" value="<?php echo e(old('govt_pension_no')); ?>" >                                
                             <?php if($errors->has('id')): ?>
                                    <span class="help-block">
                                ...
                                <div class="col-md-6">
                                   <div class="form-group">
                                        ...
                                        <input type="text"  pattern="[E][B][-][\d]{2,}" required class="form-control" id="enat_id" name="enat_id"
                                         placeholder="eg. EB-id_no" value="<?php echo e(old('enat_id')); ?>">       
                                           <?php if($errors->has('id')): ?>
                                    <span class="help-block">
                                ...
                                <?php endif; ?>                                                                                      
                                 ...
                                 <div class="form-group">
                                    ...
                                    <option value="">-----Select Branch -----
                                        ...
                                        <option value="<?php echo e($br->id); ?>" <?php if(old('branch_id') == "$br->id"): ?> <?php echo e('selected'); ?> <?php endif; ?>><?php echo e($br->branch_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <select>
                            ...
                            <input type="date" class="form-control" id="birth_date" name="birth_date" required value="<?php echo e(old('birth_date')); ?>" >                                
                          <?php if($errors->has('birth_date')): ?>
                                    ...
                                    <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                            name="houseno" id="houseno" value="<?php echo e(old('houseno')); ?>">
                                              <?php if($errors->has('houseno')): ?>
                                    <span class="help-block">
                                        <strong  class="text-danger"><?php echo e($errors->first('houseno')); ?></strong>
                                    </span>
                                    <?php endif; ?>
                                    </div>
                             <div class="form-group">
