            ...
            <td style="<?php echo e($style['email-wrapper']); ?>" align="center">
                ...
                <p id="p1">
                 ...
                 <table id="employees">
                           ...
                           <?php $__currentLoopData = $Aemployee; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aemp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	
	
	<tr >
		
		<td><span>
			<?php echo e($aemp->employee_name); ?>


		</span></td>
		
		<td><span>
			<?php echo e($aemp->job_position); ?>


		</span></td>
    <td><span>
        	<?php echo e($aemp->acting_job_position); ?>

			

		</span></td>
        <td><span>
		<?php echo e($aemp->home_branch); ?>
