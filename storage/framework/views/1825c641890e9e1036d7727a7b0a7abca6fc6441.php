        ...
        <form action="searchtransferpromotion" method="get">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">Employees Transfer/Promotion Records
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Transferpromotion::class)): ?>
                        ...
                        <tbody>
                         ...
                         ?>  
                            ...
                            <tr>                                
                                ...
                                <td>
                                 <a href="<?php echo e(route('transferpromotion.show', $employee->id)); ?>" class="btn-success btn-sm">
                                 <i class="fa fa-info-circle"></i> </a>
                                 </td>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update',App\Transferpromotion::class)): ?>
                                <td>                                
                                <a href="<?php echo e(route('transferpromotion.edit', $employee->id)); ?>" class="btn-warning btn-sm" >
                                <i class="fa fa-edit"></i></a></td>
                                <?php endif; ?>  
                                 <td>
                                  <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete',App\Transferpromotion::class)): ?>
                                  	<form action="/transferpromotion/<?php echo e($employee->id); ?>" method="POST">
